...
public class NavCategoryDetalleAdapterNews extends RecyclerView.Adapter<NavCategoryDetalleAdapterNews.ViewHolder>{

    private Context context;
    FirebaseDatabase database;
    String iduser;
    List<NavCategoryDetalleModelNews> list;    //CAMBIAR
    ...
    public NavCategoryDetalleAdapterNews(Context context, List<NavCategoryDetalleModelNews> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new NavCategoryDetalleAdapterNews.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.nav_category_detalle_item_news, parent, false));
    }
